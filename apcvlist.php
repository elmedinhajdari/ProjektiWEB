                        ...
                        while ($fetch_cv = mysqli_fetch_assoc($reg_cv)) { ?>
                            <tr>
                                ...
                                <td><?php echo $fetch_cv['size']; ?></td>
                                    ...
                                    <form method="post" action="apcvlist.php">
                                        <input type="hidden" name="user_id" value="<?php echo $fetch_cv['id']; ?>">
                                        <input type="hidden" name="user_name" value="<?php echo $fetch_cv['name1']; ?>">
                                        <input type="hidden" name="user_role" value="<?php echo $fetch_cv['surename']; ?>">
                                        <input type="hidden" name="user_id" value="<?php echo $fetch_cv['phone']; ?>">
                                        <input type="hidden" name="user_name" value="<?php echo $fetch_cv['city']; ?>">
                                        <input type="hidden" name="user_role" value="<?php echo $fetch_cv['name']; ?>">
                                        <input type="hidden" name="user_name" value="<?php echo $fetch_cv['size']; ?>">
                                        <input type="hidden" name="user_role" value="<?php echo $fetch_cv['downloads']; ?>">
